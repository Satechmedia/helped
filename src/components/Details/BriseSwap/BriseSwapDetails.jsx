  ...
  function Details() {
    ...
    return (
      <div style={styles.body}>
        ...
        <div className="icons">
          <a href="https://twitter.com/Brisepadco?t=MZ9-lHiu_Q5yhxvg9S5ahQ&s=09">
            <Avatar className="icon" size={28} icon={<TwitterOutlined />} />
          </a>
          <a href="https://t.me/brisepadco">
            <Avatar className="icon" size={28} src="/telegram.webp" />
          </a>
          <a href="http://briseswap.finance/">
            <Avatar className="icon" size={28} icon={<ChromeOutlined />} />
          </a>
          <a href="https://github.com/Brisepad">
        ...
        <p className="cap">1 BPAD = 1.82 BSWAP</p>
        <Row align="middle">
          <Col lg={8} md={24} sm={24} xs={24} className="desc-col">
            <p className="desc">
              BriseSwap is the most advanced DEX on Bitgert Chain. Briseswap is
              the child project of Brisepad team that have been the most effective
              team ever since joining Bitgert chain. BriseSwap brings true defi to
              the bitgert chain by providing farms and pools for all solid
              projects on the chain. This ensures every project has an utility
              that not only rewards their holders but also increase their
              liquidity.
            </p>
